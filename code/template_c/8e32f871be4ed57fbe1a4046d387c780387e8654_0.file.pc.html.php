...
/* Smarty version 3.1.30, created on 2017-02-23 21:00:23
  from "D:\PHP_tools\Apache 2.4.23\Apache24\htdocs\hospital\tpl\pc.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58aedce75eee43_24159954',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8e32f871be4ed57fbe1a4046d387c780387e8654' => 
    array (
      0 => 'D:\\PHP_tools\\Apache 2.4.23\\Apache24\\htdocs\\hospital\\tpl\\pc.html',
      1 => 1487854720,
      2 => 'file',
    ),
  ),
...
function content_58aedce75eee43_24159954 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
			                ...
			                <div class="row">
			                	<form name="query" class="form top form-inline" action="index.php?controller=users&method=showMyInfo" method="post">
			                	 	<div class="form-group col-md-3">
			                			<select class="form-control" name="date" id="date" style="">
			                     				<option>全部</option>
			                     				<option>今天</option>
			                   					<option>近一个月</option>
			                   					<option>近一年</option>
			                		...
			                		<input type="text" class="form-control" id="appointmentid" name="theAppointmentId" placeholder="订单号" >
			                		</div>

			                		<div class="form-group col-md-3">
			                				<select name="theDoctorId" id="select" onchange="setProject1(this.value)"  class="form-control" style="">
...
?>
			                		...
			                		<div class="form-group col-md-3">
			                			<select name="theProjectId" id="select"  class="form-control" style="">
...
?>
			                		...
			                		<div class="form-group col-md-1">
			                			<input type="submit" class="form-control btn btn-info col-md-2" value="查询">
			                		</div>			                		
